...
sub-class variants within each group.
...
Outputs saved to a timestamped folder under inference_eval_clstm/.

Usage:
  python evaluate_realtime_clstm.py
  python evaluate_realtime_clstm.py --hold 8 --rest 7
'''
...
def main():
    parser = argparse.ArgumentParser(description='Real-time C-LSTM evaluation')
